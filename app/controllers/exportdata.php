...
class Exportdata extends Controller{
	...
	public function exportcriticalpart($strdate, $enddate){
		...
		$excel->setActiveSheetIndex(0)->setCellValue('AK1', "QA STATUS");		
		...
		foreach($data['expdata'] as $i => $h){ // Ambil semua data dari hasil eksekusi $sql
			...
			$excel->setActiveSheetIndex(0)->setCellValue('K'.$numrow, $h['quantity']);
			...
			$excel->setActiveSheetIndex(0)->setCellValue('P'.$numrow, $h['DB1']);
			$excel->setActiveSheetIndex(0)->setCellValue('Q'.$numrow, $h['db1ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('R'.$numrow, $h['db1ft']);

			$excel->setActiveSheetIndex(0)->setCellValue('S'.$numrow, $h['IC1']);
			$excel->setActiveSheetIndex(0)->setCellValue('T'.$numrow, $h['ic1ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('U'.$numrow, $h['ic1ft']);
			$excel->setActiveSheetIndex(0)->setCellValue('V'.$numrow, $h['PC1']);
			$excel->setActiveSheetIndex(0)->setCellValue('W'.$numrow, $h['pc1ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('X'.$numrow, $h['pc1ft']);
			$excel->setActiveSheetIndex(0)->setCellValue('Y'.$numrow, $h['D1']);
			$excel->setActiveSheetIndex(0)->setCellValue('Z'.$numrow, $h['d1ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('AA'.$numrow, $h['d1ft']);
			$excel->setActiveSheetIndex(0)->setCellValue('AB'.$numrow, $h['D2']);
			$excel->setActiveSheetIndex(0)->setCellValue('AC'.$numrow, $h['d2ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('AD'.$numrow, $h['d2ft']);
			$excel->setActiveSheetIndex(0)->setCellValue('AE'.$numrow, $h['T1']);
			$excel->setActiveSheetIndex(0)->setCellValue('AF'.$numrow, $h['t1ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('AG'.$numrow, $h['t1ft']);
			$excel->setActiveSheetIndex(0)->setCellValue('AH'.$numrow, $h['QF1']);
			$excel->setActiveSheetIndex(0)->setCellValue('AI'.$numrow, $h['qf1ag']);
			$excel->setActiveSheetIndex(0)->setCellValue('AJ'.$numrow, $h['qf1ft']);
			$excel->setActiveSheetIndex(0)->setCellValue('AK'.$numrow, $h['qa_result']);
