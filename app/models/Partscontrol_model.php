...
class Partscontrol_model{
    ...
    public function saveWHIssuance($data){
        $query = "INSERT INTO t_warehouse_issuance (assy_code, part_lot, quantity, location, status, issueance_date, createdby, createdon) VALUES (:assy_code, :part_lot, :quantity, :location, :status, :issueance_date, :createdby, :createdon)";
        $this->db->query($query);
