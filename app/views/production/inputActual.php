                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="hourlytime" id="hourlytime" class="form-control">
                                                        <option value="">Selct Hourly Time</option>
                                                        <?php foreach($data['hrtimes'] as $d) : ?>
                                                            <option value="<?= $d['hourly_time']; ?>"><?= $d['hourly_time']; ?></option>
                                                        <?php endforeach; ?>
