                                            ...
                                            <tbody>
                                                <?php foreach ($data['rday1'] as $row) : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;"><?= $row['planqtyd1s1'] - $row['qtyoutd1s1']; ?></td>
                                                    </tr>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <?php foreach ($data['rday1'] as $row) : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php endif; ?>
                                                        <td style="text-align:right;"><?= $row['planqtyd1s2'] - $row['qtyoutd1s2']; ?></td>
                                                    </tr>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <?php foreach ($data['rday2'] as $row) : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;"><?= $row['planqtyd2s1'] - $row['qtyoutd2s1']; ?></td>
                                                    </tr>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <?php foreach ($data['rday2'] as $row) : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php endif; ?>
                                                        <td style="text-align:right;"><?= $row['planqtyd2s2'] - $row['qtyoutd2s2']; ?></td>
                                                    </tr>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </tbody>
